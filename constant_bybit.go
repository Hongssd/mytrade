...
const (
	...
	BYBIT_AC_MARGIN  BybitAccountType = "MARGIN"  //杠杆
...
const (
	...
	BYBIT_ORDER_STATUS_TRIGGERED        = "Triggered"
	BYBIT_ORDER_STATUS_UNTRIGGERED      = "Untriggered"
	...
	BYBIT_ORDER_STATUS_DEACTIVATED               = "Deactivated"
)
...
const (
	BYBIT_ORDER_TRIGGER_CONDITION_TYPE_THROUGH_UP   = 1
	BYBIT_ORDER_TRIGGER_CONDITION_TYPE_THROUGH_DOWN = 2
)
