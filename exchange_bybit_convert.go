...
func (c *BybitEnumConverter) FromBYBITOrderStatus(t string) OrderStatus {
	switch t {
	case BYBIT_ORDER_STATUS_UNTRIGGERED:
		return ORDER_STATUS_UN_TRIGGERED
	case BYBIT_ORDER_STATUS_NEW, BYBIT_ORDER_STATUS_TRIGGERED:
	...
	case BYBIT_ORDER_STATUS_CANCELED, BYBIT_ORDER_STATUS_PARTIALLY_FILLED_CANCELED, BYBIT_ORDER_STATUS_DEACTIVATED:
...
func (c *BybitEnumConverter) FromBYBITAssetType(t string) AssetType {
	switch t {
	case BYBIT_ASSET_TYPE_FUND:
		return ASSET_TYPE_FUND
	case BYBIT_ASSET_TYPE_UNIFIED:
		return ASSET_TYPE_UNIFIED
	case BYBIT_ASSET_TYPE_CONTRACT:
		return ASSET_TYPE_CONTRACT
	default:
		return ""
	}
}
